    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-[1100px] mx-auto px-6 py-[72px] pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-10 items-center">
            ...
            <div>
              ...
              <FadeIn delay={100}>
                <p className="font-body text-lg md:text-xl text-white/60 mt-5 leading-relaxed max-w-[460px]">
              ...
              <FadeIn delay={200}>
                ...
                <p className="font-body text-sm md:text-base text-white/40 mt-3">
              ...
              <FadeIn delay={300}>
                ...
                <div className="grid grid-cols-3 border-t border-white/[0.08] pt-5 gap-4">
                  ...
                  <div className="md:pl-5">
                    ...
                    <p className="font-body text-xs md:text-sm text-white/50 mt-1">corredores te dicen esto antes de firmar</p>
                  </div>
                </div>
            ...
            <FadeIn delay={200} className="hidden lg:block">
              <div className="relative" style={{ perspective: "1400px", height: "560px" }}>
                ...
                >
                  ...
                  <svg viewBox="0 0 180 80" className="w-full mb-2">
                    ...
                    {[12,20,28,38,50,60,72,82,92,100].map((h, i) => (
                      <g key={i}>
                        <rect x={i*18+2} y={80-h*0.7} width="12" height={h*0.25} rx="1" fill="rgba(250,250,248,0.12)" />
                        <rect x={i*18+2} y={80-h*0.7+h*0.25} width="12" height={h*0.2} rx="1" fill="rgba(250,250,248,0.2)" />
                        <rect x={i*18+2} y={80-h*0.7+h*0.45} width="12" height={h*0.25} rx="1" fill="rgba(250,250,248,0.3)" />
                      </g>
                    ))}
                    {/* Debt line */}
                    ...
                    {/* Patrimonio line */}
                    <polyline points="8,62 26,55 44,47 62,38 80,30 98,23 116,17 134,12 152,8 170,5" fill="none" stroke="#FAFAF8" strokeWidth="1.5" opacity="0.8" />
                  </svg>
                ...
                <div
                  className="absolute top-0 left-[100px] w-[280px] rounded-[18px] border border-white/[0.1] p-5 z-10"
                ...
                >
                  ...
                  <div className="border-l-2 border-[#C8323C] pl-2.5 mb-3.5">
                    <p className="font-body text-[9px] text-white/60 leading-relaxed">
                      <span className="font-semibold text-white/80">Siendo franco:</span> este depto te cuesta $382K/mes. Negociable si consigues mejor precio.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-1.5 mb-3.5">
                    {[
                      ...
                      <div key={d.label} className="flex-1 text-center">
                        ...
                        <p className="font-body text-[6px] text-white/30 mt-1">{d.label}</p>
                        <p className={`font-mono text-[7px] font-medium ${d.v < 40 ? "text-[#C8323C]" : d.v < 70 ? "text-[#FBBF24]" : "text-[#B0BEC5]"}`}>{d.v}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="border-t border-white/[0.06] pt-3">
                    ...
                    <div className="grid grid-cols-4 gap-1.5">
                      {[
                        ...
                        <div key={item.label} className={`rounded-md p-1.5 text-center ${item.highlight ? "bg-[#C8323C]/10 border border-[#C8323C]/20" : "bg-white/[0.03]"}`}>
                ...
                >
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="font-body text-[9px] text-white/50 font-semibold">Análisis IA</span>
                  </div>
                  ...
                  <div className="border-t border-white/[0.06] pt-2.5 mb-2">
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        { label: "Base", flujo: "-$86K", ret: "4.5x", bg: "bg-white/[0.03]" },
                        ...
                        <div key={s.label} className={`flex justify-between items-center ${s.bg} rounded-md px-2 py-1`}>
                          <span className="font-body text-[7px] text-white/40">{s.label}</span>
                          <div className="flex gap-2">
                            <span className="font-mono text-[8px] text-white/60">{s.flujo}</span>
                            <span className="font-mono text-[8px] font-bold text-white/80">{s.ret}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2.5">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-body text-[7px] text-white/40">Precio/m²</span>
                        <span className="font-mono text-[8px] text-white/60">$2.7M vs $2.9M</span>
                      </div>
                      <div className="flex gap-0.5">
                        <div className="h-[6px] rounded-full" style={{ width: "88%", background: "rgba(250,250,248,0.35)" }} />
                        <div className="h-[6px] rounded-full flex-1" style={{ background: "rgba(250,250,248,0.1)" }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-body text-[7px] text-white/40">Arriendo</span>
                        <span className="font-mono text-[8px] text-white/60">$917K vs $612K</span>
                      </div>
                      <div className="flex gap-0.5">
                        <div className="h-[6px] rounded-full" style={{ width: "100%", background: "rgba(250,250,248,0.35)" }} />
                      </div>
                      <div className="mt-0.5 flex gap-0.5">
                        <div className="h-[6px] rounded-full" style={{ width: "67%", background: "rgba(250,250,248,0.15)" }} />
            ...
            <FadeIn delay={200} className="lg:hidden flex flex-col items-center gap-3 w-full">
              <p className="font-mono text-[8px] text-white/30 uppercase tracking-[0.1em] text-center">Ejemplo de análisis</p>

              {/* Main card */}
              <div className="rounded-[18px] border border-white/[0.1] p-5 w-[92%] max-w-[400px]" style={{ background: "#151515", boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }}>
                {/* Score + info */}
                <div className="flex items-start gap-3.5 mb-4">
                ...
                <div className="flex gap-2 mb-4">
                  {[
                    ...
                    <div key={d.label} className="flex-1 text-center">
                      ...
                      <p className={`font-mono text-[8px] font-medium ${d.v < 40 ? "text-[#C8323C]" : d.v < 70 ? "text-[#FBBF24]" : "text-[#B0BEC5]"}`}>{d.v}</p>
                    </div>
                  ))}
                </div>
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={s.label} className={`flex justify-between items-center ${s.bg} rounded-md px-3 py-1.5`}>
                        <span className="font-body text-[9px] text-white/40">{s.label}</span>
                        <div className="flex gap-3">
                          <span className="font-mono text-[10px] text-white/60">{s.flujo}</span>
                          <span className="font-mono text-[10px] font-bold text-white/80">{s.ret}</span>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="text-center mt-10">
            <p className="font-body text-sm md:text-base text-white/40">Descubre cómo funciona</p>
            <p className="font-body text-2xl md:text-3xl text-white/30 mt-1 animate-bounce">↓</p>
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="bg-white py-16">
        <div className="max-w-[800px] mx-auto px-6">
          <FadeIn>
            <h2 className="font-heading font-bold text-2xl md:text-[28px] text-[#0F0F0F] text-center tracking-tight">
              Así de simple
            </h2>
            <p className="font-body text-base text-[#71717A] text-center mt-2 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <FadeIn key={step.num} delay={i * 100} className="text-center">
                ...
                <p className="font-body text-base text-[#71717A] leading-snug">{step.desc}</p>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="bg-[#FAFAF8] py-16">
        <div className="max-w-[560px] mx-auto px-6">
          <FadeIn>
            ...
            <p className="font-body text-base text-[#71717A] text-center mt-2 mb-8">
          ...
          <FadeIn delay={100}>
            <div className="bg-white rounded-2xl border border-[#E6E6E2] p-5 md:p-8 shadow-sm">
              ...
              <div className="flex items-start justify-between">
                <div>
                  <p className="font-mono text-[10px] text-[#71717A] uppercase tracking-[0.1em]">Franco Score</p>
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-3 mt-5">
                <div className="bg-[#FAFAF8] rounded-[10px] p-2.5 md:p-3.5 text-center">
                  <p className="font-body text-[9px] md:text-[10px] text-[#71717A] uppercase tracking-wide">Flujo mensual</p>
                  <p className="font-mono text-lg md:text-xl font-bold text-[#C8323C]">-$290K</p>
                </div>
                <div className="bg-[#FAFAF8] rounded-[10px] p-2.5 md:p-3.5 text-center">
                  <p className="font-body text-[9px] md:text-[10px] text-[#71717A] uppercase tracking-wide">Rent. neta</p>
                  <p className="font-mono text-lg md:text-xl font-bold text-[#0F0F0F]">2.3%</p>
                </div>
                <div className="bg-[#FAFAF8] rounded-[10px] p-2.5 md:p-3.5 text-center">
                  <p className="font-body text-[9px] md:text-[10px] text-[#71717A] uppercase tracking-wide">Retorno 10a</p>
                  <p className="font-mono text-lg md:text-xl font-bold text-[#0F0F0F]">3.21x</p>
                </div>
              </div>

              {/* Siendo franco box */}
              <div className="mt-5 p-3.5 bg-[#C8323C]/[0.03] rounded-[10px] border-l-[3px] border-[#C8323C]">
                <p className="font-body text-sm md:text-[15px] text-[#0F0F0F] leading-relaxed">
              ...
              <div className="text-center mt-6">
                ...
                <p className="font-body text-xs text-[#71717A] mt-2">Registro gratis. Resultado en 30 segundos.</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      >
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <FadeIn delay={100}>
            <div className="flex flex-col md:flex-row gap-4 md:gap-5 mt-9 mb-8">
              ...
              <div className="flex-1 relative bg-white/[0.05] border-2 border-[#C8323C] rounded-xl p-6 md:p-8" style={{ boxShadow: "0 0 30px rgba(200,50,60,0.06)" }}>
                ...
                <p className="font-mono text-[10px] text-white/80 uppercase tracking-[0.1em] font-semibold mb-3">FRANCO TE MUESTRA</p>
          ...
          {/* Punchline */}
          <FadeIn delay={200}>
            <p className="font-body text-base text-white/50 text-center mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <FadeIn key={i} delay={250 + i * 80}>
                <div className="bg-white/[0.03] border border-white/[0.06] rounded-[10px] p-4 md:p-5">
      ...
      <section className="bg-[#FAFAF8] py-12">
        <div className="max-w-[600px] mx-auto px-6 text-center">
          <FadeIn>
            <p className="font-body text-lg md:text-xl font-semibold text-[#0F0F0F]">Solo datos. Cero comisiones.</p>
            <p className="font-body text-base text-[#71717A] leading-relaxed mt-2 mb-6">
            ...
            <div className="flex justify-center items-center gap-6 md:gap-10 flex-wrap">
              ...
              <div className="flex flex-col items-center gap-2.5">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-50">
                  <rect x="2" y="2" width="32" height="32" rx="4" stroke="#71717A" strokeWidth="1.5" fill="none" />
                  <rect x="8" y="18" width="4" height="10" rx="1" fill="#71717A" />
                  <rect x="16" y="12" width="4" height="16" rx="1" fill="#71717A" />
                  <rect x="24" y="8" width="4" height="20" rx="1" fill="#71717A" />
                  <circle cx="10" cy="14" r="1.5" fill="#71717A" />
                  <circle cx="18" cy="9" r="1.5" fill="#71717A" />
                  <circle cx="26" cy="6" r="1.5" fill="#71717A" />
                  <path d="M10 14 L18 9 L26 6" stroke="#71717A" strokeWidth="1" />
                </svg>
                <span className="font-body text-xs text-[#71717A]">Datos de mercado</span>
              </div>
              {/* Banco Central */}
              <div className="flex flex-col items-center gap-2.5">
                <Image src="/logos/banco-central.png" alt="Banco Central de Chile" width={36} height={36} className="h-9 w-9 opacity-40" />
                <span className="font-body text-xs text-[#71717A]">Banco Central</span>
              </div>
              {/* SII */}
              <div className="flex flex-col items-center gap-2.5">
                <Image src="/logos/sii.jpg" alt="Servicio de Impuestos Internos" width={120} height={40} className="h-7 w-auto opacity-40 grayscale" />
                <span className="font-body text-xs text-[#71717A]">Serv. Impuestos</span>
              </div>
              {/* CMF */}
              <div className="flex flex-col items-center gap-2.5">
                ...
                <span className="font-body text-xs text-[#71717A]">Com. Mercado Fin.</span>
              </div>
            </div>
          </FadeIn>
          ...
          {/* ChatGPT note */}
          <FadeIn delay={200}>
            <p className="mt-6 font-body text-xs text-[#71717A] italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 items-start">
            ...
            <FadeIn delay={0}>
              <div className="rounded-xl border border-[#E6E6E2] bg-white p-5 h-full flex flex-col">
                ...
                <p className="font-mono text-3xl font-bold text-[#0F0F0F] mt-1">$0</p>
            ...
            <FadeIn delay={80}>
              <div className="relative rounded-xl border-2 border-[#C8323C] bg-white p-5 md:-mt-2 md:mb-[-8px] flex flex-col" style={{ boxShadow: "0 4px 24px rgba(200,50,60,0.07)" }}>
                ...
                <p className="font-mono text-3xl font-bold text-[#0F0F0F] mt-1">$4.990<span className="font-body text-sm font-normal text-[#71717A]"> /análisis</span></p>
                <p className="font-body text-sm text-[#71717A] mt-1">Todo gratis + análisis IA completo</p>
            ...
            <FadeIn delay={160}>
              <div className="relative rounded-xl border border-[#E6E6E2] bg-white p-5 h-full flex flex-col">
                ...
                <p className="font-mono text-3xl font-bold text-[#0F0F0F] mt-1">$19.990<span className="font-body text-sm font-normal text-[#71717A]"> /mes</span></p>
      ...
      >
        ...
        <div className="relative z-10 px-6">
          <FadeIn>
            ...
            <p className="font-body text-base md:text-lg text-white/50 mt-3">
