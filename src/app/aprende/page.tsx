  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F]">
      ...
      <div className="max-w-[640px] mx-auto px-6 pt-16 md:pt-24 pb-10">
        ...
        <p className="font-body text-[15px] text-[#FAFAF8]/50 mt-3">
      ...
      <div className="max-w-[640px] mx-auto px-6 pb-12">
        <Link
          ...
          className="block rounded-2xl border border-white/[0.08] bg-[#151515] p-6 hover:border-white/20 transition-colors"
        >
          ...
          <p className="font-body text-[13px] text-[#FAFAF8]/50 mt-2 leading-relaxed">
      ...
      {/* Bottom CTA */}
      <div className="bg-[#151515] border-t border-white/[0.08] py-14 text-center px-6">
        <p className="font-heading font-bold text-xl text-[#FAFAF8] mb-2">
          ¿Quieres saber si tu depto vale la pena?
        </p>
        <p className="font-body text-sm text-[#FAFAF8]/50 mb-6">
