...
import { normalizeMetrics, fmtCLP, fmtUF, fmtMoney, fmtAxisMoney, parseUFString } from "@/components/analysis/utils";
import { DatoCard } from "@/components/analysis/DatoCard";
import { MiniCard } from "@/components/analysis/MiniCard";
// Ronda 4a.2: Advanced Section components — recharts/KPICard/SliderSimulacion/
// useSimulation/calculateKPIs/tonoXxx/YearProjection/AnalysisMetrics ya no se
// referencian en este archivo, viven en los componentes movidos.
