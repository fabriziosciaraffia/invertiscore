...
export function AnalysisNav({
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-th-border-strong bg-th-nav">
      <div className="container mx-auto flex h-14 items-center justify-between px-4">
          ...
          {isGuest ? (
            ...
            <>
              ...
              <Link href={isSharedView ? "/analisis/nuevo" : "/dashboard"}>
                <Button variant="ghost" size="sm" className="gap-2 text-th-text-secondary hover:text-th-text hover:bg-th-surface">
        ...
        <div className="relative md:hidden" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full mt-2 z-50 w-52 rounded-xl border border-th-border-strong bg-th-card p-3 shadow-lg">
              <div className="flex flex-col gap-1">
                {isGuest ? (
                  <>
                    ...
                    <Link href="/register" onClick={() => setMenuOpen(false)}>
                      <Button size="sm" className="w-full gap-2 bg-th-page text-th-text hover:opacity-90">
                        Registrarme gratis
                      </Button>
                    </Link>
                  </>
