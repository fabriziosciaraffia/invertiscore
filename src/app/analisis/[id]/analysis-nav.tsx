    ...
    <nav className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#0F0F0F]">
      <div className="container mx-auto flex h-14 items-center justify-between px-4">
          ...
          {isGuest ? (
            ...
            <>
              ...
              <Link href={isSharedView ? "/analisis/nuevo" : "/dashboard"}>
                <Button variant="ghost" size="sm" className="gap-2 text-[#FAFAF8]/70 hover:text-[#FAFAF8] hover:bg-white/[0.08]">
        ...
        <div className="relative md:hidden" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full mt-2 z-50 w-52 rounded-xl border border-white/[0.08] bg-[#151515] p-3 shadow-lg">
              <div className="flex flex-col gap-1">
                {isGuest ? (
                  <>
                    ...
                    <Link href="/register" onClick={() => setMenuOpen(false)}>
                      <Button size="sm" className="w-full gap-2 bg-[#0F0F0F] text-white hover:bg-[#0F0F0F]/90">
                        Registrarme gratis
                      </Button>
                    </Link>
                  </>
