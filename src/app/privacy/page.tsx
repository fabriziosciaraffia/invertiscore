      ...
      <main className="max-w-[640px] mx-auto px-6 py-16 md:py-24">
        ...
        <div className="mt-10 space-y-10">
          ...
          <section>
            ...
            <div className="font-body text-[15px] text-[#FAFAF8]/80 leading-relaxed mt-3 space-y-3">
              <p>
          ...
          <section>
            ...
            <ul className="font-body text-[15px] text-[#FAFAF8]/80 leading-relaxed mt-3 space-y-2 list-disc pl-5">
          ...
          <section>
            ...
            <div className="rounded-xl bg-[#1A1A1A] border border-white/[0.08] p-5 mt-3">
              <ul className="font-body text-[15px] text-[#FAFAF8]/80 leading-relaxed space-y-2">
