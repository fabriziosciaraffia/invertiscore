      ...
      <section className="px-4 pb-20">
        <div className="max-w-[1020px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 md:items-stretch">
          ...
          <FadeIn delay={0} className="flex">
            <div className="rounded-2xl border border-white/[0.08] bg-[#151515] p-6 md:p-7 flex flex-col w-full">
          ...
          <FadeIn delay={200} className="flex">
            <div className="relative rounded-2xl border border-white/[0.08] bg-[#151515] p-6 md:p-7 flex flex-col w-full">
