...
export const VOSEO_A_TUTEO: Readonly<Record<string, string>> = {
  ...
  venis: "vienes",
  volves: "vuelves",
  // ── Altas del 06-sep-2026 (auditoría de voseo en prosa persistida) ──
  // Presentes con raíz en "r" (la exclusión /rás$/ del futuro no los ve), -és que
  // solo detectaba la morfología, e imperativos -á/-é y reflexivos, que la
  // morfología no mira: sin léxico no se cazan ni se corrigen. Los imperativos -í
  // que coinciden con un pretérito de primera persona (seguí, pedí, elegí, medí)
  // se dejan fuera a propósito: el swap sería un falso positivo en "yo seguí".
  podés: "puedes",
  conocés: "conoces",
  separás: "separas",
  tirás: "tiras",
