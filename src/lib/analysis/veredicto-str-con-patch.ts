...
/**
 * Veredicto Y Franco Score del MISMO recompute — lo que consume el mix de palancas, que
 * desde el 13-sep-2026 elige la celda por score y no por descuento mínimo.
 *
 * Los dos salen del mismo `calcFrancoScoreSTR`, así que el score es siempre el que produjo
 * ese veredicto. El mix compara scores dentro de una modalidad y en la misma escala 0-100
