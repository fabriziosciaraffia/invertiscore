...
- En \`conviene.respuestaDirecta\` (lo primero que se lee, ANTES de cualquier card): si usas CAP rate, TIR, NOI, break-even o cash-on-cash ahí, la glosa va ahí — "CAP rate (lo que el arriendo deja al año sobre el precio, descontados los gastos)", "TIR (rentabilidad anual de tu inversión)", "NOI (lo que queda del arriendo tras los gastos operativos, antes del crédito)". No importa que una card lo explique más abajo: el lector llega primero a tu prosa.
