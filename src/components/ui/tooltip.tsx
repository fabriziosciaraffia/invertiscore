  ...
  return (
    <span className="inline-flex">
      <button
        ref={triggerRef}
        type="button"
        className="inline-flex items-center justify-center w-[14px] h-[14px] rounded-full bg-white/[0.06] font-mono text-[9px] text-[#FAFAF8]/25 cursor-help shrink-0 hover:bg-white/[0.12] hover:text-white/50 transition-colors"
