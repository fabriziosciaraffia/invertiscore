    ...
    <section className="bg-[#FAFAF8]">
      <div className="mx-auto max-w-[1280px] px-6 py-24 md:py-32">
        ...
        <div className="max-w-[760px]">
          ...
          <h2 className="mt-5 font-heading text-[36px] font-bold leading-[1.1] tracking-[-0.01em] text-[#0F0F0F] md:text-[48px]">
            La matemática del depto de inversión cambió.
          </h2>
          <p className="mt-5 max-w-[640px] font-body text-[16px] leading-[1.55] text-[#0F0F0F]/72 md:text-[17px]">
        ...
        {/* Bloque negro */}
        <div className="mt-10 rounded-2xl bg-[#0F0F0F] p-8 md:p-12">
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-[auto_1px_1fr] md:gap-12">
            <p className="font-heading text-[64px] font-bold leading-none tracking-[-0.025em] text-[#C8323C] md:text-[88px]">
              92,1%
            </p>
            ...
            <div className="md:pl-2">
              ...
              <p className="mt-3 font-heading text-[22px] font-bold leading-[1.25] text-[#FAFAF8] md:text-[26px]">
                de los deptos de inversión pierden plata cada mes.
              </p>
              <p className="mt-3 font-body text-[14px] leading-[1.55] text-[#FAFAF8]/72 md:text-[15px]">
        ...
        {/* Footnote */}
        <p className="mt-6 max-w-[860px] font-body text-[11px] leading-[1.55] text-[#0F0F0F]/45">
...
function ProblemCard({
  ...
  return (
    <div
      className="rounded-xl p-7 transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5"
      style={
        highlighted
          ? {
    ...
    >
      ...
      <p
        className="mt-5 font-heading font-bold leading-none tracking-[-0.02em]"
        style={{ color: bigColor, fontSize: "56px" }}
      >
        {big}
      </p>
      <p className="mt-4 font-mono text-[11px] font-medium text-[#0F0F0F]/55">
        {sublabel}
      </p>
      <div
