  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row sm:gap-2">
      <input
        ...
        required
        className="flex-1 rounded-lg border bg-transparent px-4 py-3 font-body text-sm text-[#FAFAF8] placeholder:text-[#FAFAF8]/30 focus:border-[#C8323C] focus:outline-none focus:ring-1 focus:ring-[#C8323C]/20"
