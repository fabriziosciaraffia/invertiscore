...
export function normalizeMetrics(metrics: any): AnalysisMetrics | null {
  ...
  return {
    ...
    // T5: sin los fallbacks a `valorMercadoUF` / `plusvaliaInmediata(Pct)`, nombres
    // pre-rename que ningún tipo declara y ninguna fila viva trae.
    valorMercadoFrancoUF: metrics.valorMercadoFrancoUF ?? 0,
    valorMercadoUsuarioUF: metrics.valorMercadoUsuarioUF ?? 0,
    plusvaliaInmediataFranco: metrics.plusvaliaInmediataFranco ?? 0,
    plusvaliaInmediataFrancoPct: metrics.plusvaliaInmediataFrancoPct ?? 0,
    plusvaliaInmediataUsuario: metrics.plusvaliaInmediataUsuario ?? 0,
    plusvaliaInmediataUsuarioPct: metrics.plusvaliaInmediataUsuarioPct ?? 0,
